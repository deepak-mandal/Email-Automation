...
<html>
    <body>
        <p>
            ...
            I will be graduating in 2021 and looking for an internship or full-time opportunity that I may be eligible.<br/>

            <p>Apart from having a Cumulative Performance Index (CPI) of 6.99, I'm skilled in Python programming language,
             databases - SQL, Analytics, Data structures, algorithms, and web development. In addition, I have been done Projects on:
            <ul>
